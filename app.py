...
def remove_user(memID):
    ...
    GMManager = groupy.api.base.Manager(GMClient.session, '/groups/'+GROUP_ID+'/members/'+memID+'/remove')
    MemManager = groupy.api.memberships.Memberships(GMManager.session, GROUP_ID)
